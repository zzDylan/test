	...
	<body>
		...
		<div id="mother">
			<div id="errorBox">
				...
				<a href="http://tel.51gogo.club/" title="返回首页">
					<div class="link" id="home"></div>
				</a>
                            <a onclick="contact()" title="联系管理员">
    ...
    function contact(){
        try{
            if (/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
                window.location.href="tel:13075534552";
            }else{
                window.location.href="tencent://message/?uin=1298960745&Site=小卖铺&Menu=yes";
            }
        }catch(e){}
    }
</script>
